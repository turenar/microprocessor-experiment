...
module decoder(
	...
	input wire [5:0] in_opc,
	input wire [`OPTYPE_BITDEF] in_opt,
	input wire [31:0] in_rav,
	input wire [31:0] in_rbv,
	input wire [4:0] in_rout,
	input wire [10:0] in_aux,
	input wire [15:0] in_imm,
	input wire [25:0] in_addr,
	output wire [31:0] out_npc,
	output wire [31:0] out_reg_map,
	output wire [5:0] out_opc,
	output wire [`OPTYPE_BITDEF] out_opt,
	output wire [31:0] out_rav,
	output wire [31:0] out_rbv,
	output wire [4:0] out_rout,
	output wire [10:0] out_aux,
	output wire out_mem_read_enabled,
	output wire [31:0] out_mem_read_addr,
	output wire out_mem_write_enabled,
	output wire [31:0] out_mem_write_addr
	);
