module register_arbitrator (
	...
	assign Wusing_register_map = Rusing_register_map & ~(wb_check ? wb_using_register_map : 0);
	...
	always @ (posedge clk or posedge rst) begin
		if (rst) begin
			...
			if (pdc_check) begin
				if (Wpdc_using_register_map == (Wpdc_using_register_map & ~Wusing_register_map)) begin
					Rpdc_no_conflict <= 1;
